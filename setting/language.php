    ...
    $Lang = [ 
        'kz'=>[
           ...
           'email' => 'Email жазыңыз',
            ...
            'PUBLik' => 'Жариялау',
            'FIle' => 'Файлды қосу',
            'izbrannoe' => 'Таңдаулы хабарландырулар',
            'Dizbrannoe'=>'Таңдаулыларды өшіру'
        ],
        ...
        'ru'=>[
            ...
            'PUBLik' => 'Опубликовать',
            'FIle' => 'Добавить файл',
            'izbrannoe' =>'Избранные обьевление',
            'Dizbrannoe'=>'Очистить избранные'
        ],
